...
if (start_test) {
    ...
    let reasoner_q = new EasyReadingReasoner(alpha, 'q_learning', 3, gamma, 0.2, 1);
    let reasoner_d_q = new EasyReadingReasoner(alpha, 'q_learning', 3, gamma, 0.2, 0.5);
    let reasoner_d_q_c = new EasyReadingReasoner(alpha, 'q_learning', 3, gamma, 0.2, 0.9); // Best
    let reasoner_d_q_c_2 = new EasyReadingReasoner(alpha, 'q_learning', 3, gamma, 0.2, 0.95);
